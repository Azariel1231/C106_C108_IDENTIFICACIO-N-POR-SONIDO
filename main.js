//https://teachablemachine.withgoogle.com/models/ge3SZeiuP/
function startClassification()
{
navigator.mediaDevices.getUserMedia({audio:true});
classifier=ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/ge3SZeiuP/model.json'
, modelReady);
}
